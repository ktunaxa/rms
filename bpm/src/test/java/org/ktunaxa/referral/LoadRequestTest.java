 ...
 */
@ContextConfiguration("classpath:org/ktunaxa/referral/test-context.xml")
public class LoadRequestTest extends SpringActivitiTestCase {

	@Deployment(resources = { "org/ktunaxa/referral/loanRequest.bpmn20.xml" })

...
insert into ACT_ID_MEMBERSHIP (USER_ID_, GROUP_ID_) values ( 'kermit', 'aquaticEvaluator' );
insert into ACT_ID_MEMBERSHIP (USER_ID_, GROUP_ID_) values ( 'kermit', 'archaeologyEvaluator' );
insert into ACT_ID_MEMBERSHIP (USER_ID_, GROUP_ID_) values ( 'kermit', 'communityManager' );
insert into ACT_ID_MEMBERSHIP (USER_ID_, GROUP_ID_) values ( 'kermit', 'referralManager' );

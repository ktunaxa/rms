...
public interface CmisService {
	 ...
	 * @throws IOException In case there was a problem retrieving the data from the CMIS instance.
	 */
	 ...
	 * 
	 * @param document The document object to get the download link for.
	 ...
	 * 
	 * @param document The document object to get the display link for.
	 * @return The URL at which the document can be displayed. Note that credentials will probably be required to access
	 *         the URL.
	 */
	 ...
	 * @param mimeType The mime-type for the document (i.e. 'text/html').
	 * @param in The actual document contents in the form of a stream.
	 ...
	 * @throws IOException In case there was a problem saving the document in the CMIS instance. No document will have
	 ...
	 * 
	 * @param documentName The document name. If there is already a document with the same name, an exception is thrown.
	 * @param mimeType The mime-type for the document (i.e. 'text/html').
	 * @param in The actual document contents in the form of a stream.
	 * @param folderName names of the folder tree in which the document should be put
	 ...
	 *         been created.
	 */
	Document create(String documentName, String mimeType, InputStream in, long contentLength, String... folderName)
			throws IOException;
	 ...
	 * @throws IOException In case there was a problem retrieving the document from the CMIS instance, or the document
	 ...
	 * Get a certain document by it's document name.
	 * 
	 * @param documentName The name of the document to return.
	 * @return The CMIS document instance.
	 * @throws IOException In case there was a problem retrieving the document from the CMIS instance, or the document
	 *         simply doesn't exist.
	 */
	 ...
	 * @param mimeType The mime-type for the document (i.e. 'text/html').
	 * @param in The new contents as an InputStream.
	 * @throws IOException In case there was a problem updating the document in the CMIS instance, or the document
	 *         simply doesn't exist. The document will not have been updated.
	 */
	 ...
	 * @throws IOException In case there was a problem deleting the document in the CMIS instance, or the document
	 *         simply doesn't exist. The document will not have been deleted.
	 */
